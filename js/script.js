...
formContainer.innerHTML = `
    <div>
        ...
        <input id="name" placeholder="Ingrese su nombre, por favor" type="text">
    </div>
    <div>
        <label for="email">Email:</label>
        <input id="email" placeholder="Ingrese su email, por favor" type="email">
    </div>
...
function mostrarCarrito() {
    ...
    carritoHTML.innerHTML = ''; // - - - - - Limpia el contenido existente antes de mostrar los nuevos elementos - - - - - //
